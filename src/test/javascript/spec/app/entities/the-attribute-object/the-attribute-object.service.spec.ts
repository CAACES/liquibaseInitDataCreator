...
describe('Service Tests', () => {
    ...
    describe('TheAttributeObject Service', () => {
        ...
        beforeEach(() => {
            ...
            injector = getTestBed();
            service = injector.get(TheAttributeObjectService);
        ...
        describe('Service methods', () => {
            it('should call correct URL', () => {
                ...
                const resourceUrl = SERVER_API_URL + 'api/the-attribute-objects';
                expect(req.request.url).toEqual(resourceUrl + '/' + 123);
            });
            it('should return TheAttributeObject', () => {
